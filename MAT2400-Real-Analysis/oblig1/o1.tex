...
\begin{proof}[Proof of (b)]
    ...
    We know that $x_n(0) = x_0$ and $||x_n'|| \leq c$ so 
    \[
        ||x_n(t) - x_n(s)|| \leq c|t - s| 
    \]
    for all $x_n$. I.e. every function in the sequence is Lipschitz 
    bounded by the same Lipschitz constant $c$ and endpoints are 
    all the same. 
\end{proof}
